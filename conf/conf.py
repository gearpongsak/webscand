...
def re_open():
    installed = True if os.path.exists("/usr/local/bin/webscand") else False

    if installed:
        os.system("sudo webscand")
        sys.exit()

    else:
        os.system("sudo python3 webscand.py")
        sys.exit(())
